...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Shift", "Control"}, "e", awesome.quit),
    ...
    awful.key({ "Shift", "Control" },"n", function ()
          awful.util.spawn('xterm -e ranger') end),
    awful.key({ "Shift", "Control" },"u", function ()
          awful.util.spawn('devmon --unmount-all') end),
...
clientkeys = awful.util.table.join(
    awful.key({ "Shift", "Control"}, "f",      function (c) c.fullscreen = not c.fullscreen  end),
    awful.key({ "Shift", "Control"}, "q",      function (c) c:kill()                         end),
